...
void sort_pairs(void)
{
    for(int i = 0 ; i < pair_count; i++)
    {
        ...
        {
            if(preferences[pairs[y].winner][pairs[y].loser] - preferences[pairs[y].loser][pairs[y].winner] < preferences[pairs[y+1].winner][pairs[y+1].loser] - preferences[pairs[y+1].loser][pairs[y+1].winner])
            {
                pair temp = pairs[y];
                pairs[y] = pairs[y+1];
                pairs[y+1] = temp;
